...
function ReturnPolicy() {
  ...
  return (
    <div className='TermsConpage'>
         <Helmet>
        <title>Return Policy | Kids Jewellery | Tiny Tiaraa</title>
        <meta name="description" content="At Tiny Tiaraa, high-quality kids' jewellery. Return Policy guidelines, eligible products, return period, valid reasons, process, refunds & more. Contact for assistance." />
