...
function CustomisedPolicy() {
  ...
  return (
    <div className='TermsConpage'>
         <Helmet>
        <title>Customised Jewellery Policy | Kids Jewellery</title>
        <meta name="description" content="Learn about Tiny Tiaraa's custom jewellery policy | Contact for personalized kids jewellery in Gold & Silver. Located at [Location]." />
        ...
        <link rel="canonical" href="/customised-jewellery-policy" />
