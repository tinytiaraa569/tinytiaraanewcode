...
function Affiliatepolicy() {
  ...
  return (
    <div className='TermsConpage'>
           <Helmet>
        <title>Affiliate Policy | Kids Jewellery | Tiny Tiaraa</title>
        <meta name="description" content="Discover the 5% commission on net sales value & more in the Tiny Tiaraa Kids Jewellery Affiliate Program. Join us in promoting Kids Jewellery products!" />
        ...
        <link rel="canonical" href="/affiliate-program-commission-policy" />
