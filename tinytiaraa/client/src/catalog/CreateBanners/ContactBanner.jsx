...
function ContactBanner() {
  ...
  const [showNotification, setShowNotification] = useState(false);
      ...
      const handleDeleteBanner = async (id) => {
        try {
          await axios.delete(`${server}/delete-contactbanner/${id}`);
      ...
      const handleMultipleDelete = async  () => {
        ...
        try {
          ...
          await axios.post(`${server}/delete-multiple-contactbanners`, { ids: bannersToDelete });
      ...
      const changeBannerOrder = async (index, direction) => {
        ...
        try {
          await axios.post(`${server}/update-contactbanner-order`, { orderedBanners });
  ...
  return (
    <div>
        ...
        <div className="flex bg-slate-700 text-white rounded-lg py-4 px-6 justify-between items-center shadow-inner">
            <Link to="/dashboard/contactbanner/create">
              <button
              ...
              {banners.map((banner, index) => (
                ...
                >
                  ...
                  <div className="mt-1 flex items-center justify-between">
                    {/* Edit Button */}
                    <Link
                      to={`/dashboard/contactbanner/edit/${banner._id}`}
