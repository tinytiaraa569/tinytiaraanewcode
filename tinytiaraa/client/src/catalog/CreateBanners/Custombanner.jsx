  ...
  const [showNotification, setShowNotification] = useState(false);
    ...
    useEffect(() => {
      ...
      const handleDeleteBanner = async (id) => {
        try {
          await axios.delete(`${server}/delete-custombanner/${id}`);
      ...
      const handleMultipleDelete = async  () => {
        ...
        try {
          ...
          await axios.post(`${server}/delete-multiple-custombanners`, { ids: bannersToDelete });
      ...
      const changeBannerOrder = async (index, direction) => {
        ...
        try {
          await axios.post(`${server}/update-custombanner-order`, { orderedBanners });
      ...
      const exportToExcel = () => {
        ...
        XLSX.writeFile(workbook, "Custombanners.xlsx");
      };
      ...
      const toggleBannerLiveStatus = async (id) => {
        try {
          ...
          const { data } = await axios.patch(`${server}/custombanners/${id}/live-toggle`);
  ...
  return (
    <div>
        ...
        <div className="flex bg-slate-700 text-white rounded-lg py-4 px-6 justify-between items-center shadow-inner">
            <Link to="/dashboard/custombanner/create">
              <button
              ...
              {banners.map((banner, index) => (
                ...
                >
                  ...
                  <div className="mt-1 flex items-center justify-between">
                    {/* Edit Button */}
                    <Link
                      to={`/dashboard/custombanner/edit/${banner._id}`}
