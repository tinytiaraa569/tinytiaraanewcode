...
const HomeSec1 = () => {
  ...
  if (isLoading) {
    return (
      <div className="relative h-[550px] md:h-[650px] lg:h-[700px] 2xl:h-[780px] w-full flex items-center overflow-hidden">
        <div
          className={cn(
            "absolute inset-0 z-0 bg-gradient-to-r transition-opacity duration-1000",
            "from-[#ffe4e6] to-[#fbcfe8]",
          )}
        />
        <motion.div
          initial={{ scale: 1.1, opacity: 0.7 }}
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-white/40 via-white/30 to-transparent z-10" />
        <div className="container mx-auto px-4 md:px-6 z-20">
          <div className="max-w-xl md:max-w-2xl">
            <AnimatePresence mode="wait">
              <motion.div
              ...
              >
                ...
                <motion.p
                  ...
                  className="text-base md:text-lg text-gray-700 mb-8 max-w-lg"
                >
                  Delicate and beautiful jewelry designed specifically for your little ones. Our baby collection
                  features safe materials and adorable designs.
                </motion.p>
  ...
  return (
    <div className="relative w-full overflow-hidden hero-slider-container">
      <Swiper
        onBeforeInit={(swiper) => {
          swiperRef.current = swiper
        }}
        modules={[Pagination, Navigation, Autoplay, EffectFade]}
        effect="fade"
        fadeEffect={{ crossFade: true }} // Enable proper crossfade
        speed={1000}
        pagination={{
          clickable: true,
          renderBullet: (index, className) => {
      ...
      >
        {banners?.map((slide, index) => (
          <SwiperSlide key={slide.id} className="swiper-slide-fade">
            <div className="relative h-[550px] md:h-[650px] lg:h-[700px] 2xl:h-[780px] w-full flex items-center overflow-hidden">
              <div
                className={cn("absolute inset-0 z-0 bg-gradient-to-r transition-opacity duration-1000", slide.color)}
              />
              <motion.div
                initial={{ scale: 1.1, opacity: 0.7 }}
                animate={{
              ...
              />
              {/* Reduced opacity of white overlay */}
              <div className="absolute inset-0 bg-gradient-to-r from-white/10 via-white/20 to-transparent z-10" />
              <div className="container mx-auto px-4 md:px-6 z-20">
                <div className="max-w-xl md:max-w-2xl">
                  <AnimatePresence mode="wait">
                    <motion.div
